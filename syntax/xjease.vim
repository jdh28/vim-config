...
syn keyword xjeaseBuiltin    ASC BIN CHAR CONNTEST FGETI FGETS GETKEY HAS_PASSED HAS_RUN HEX LOG PINNUM PRINT PRINT_FORMAT RANDOM READABLE RESULTOF RUNSVF SAFE SEED SLEEP STRTOINT SYSTEM WAITKEY WIDTHOF WRITEABLE
