...
syn keyword xjeasePreamble   AUTHOR BOARD BYPASS CHAIN CIRCUIT COMPAT_VERSION CONNECT CONNECTOR CONSTANT DESCRIPTION DEVICE FILE_CONFIG FILENAME FILES FREQUENCY GROUND HIGH IN INPUT INTERNAL_PULLS JTAG LIST MAPPING NAME NETLIST NOWARN PACKAGE PINMAP PINS POWER RTCK SOURCES TCK TDI TDO TMS USE TEST_RESET OVERRIDE_TMS SEQUENCES SEQUENCE TMS_RESET VALUES
...
syn keyword xjeaseBuiltin    ASC BIN CHAR CONNTEST FGETI FGETS GETKEY HAS_PASSED HAS_RUN HEX INPUTBOX LOG MESSAGEBOX MESSAGEBOX_ASYNC PINNUM PRINT PRINT_FORMAT RANDOM READABLE RESULTOF RUNSVF SAFE SEED SLEEP STRTOINT SYSTEM WAITKEY WIDTHOF WRITEABLE
...
syn keyword xjeaseType       CONST FILE GLOBAL INT INTERNAL LOCAL STRING WIDTH
...
syn match   xjeaseNumConst   /\<0x[0-9A-Fa-f]\+/
